...
WebUI.click(findTestObject('Object Repository/Page_GitHub/span_New project_dropdown-caret'))

WebUI.click(findTestObject('Object Repository/Page_GitHub/a_Your profile'))

WebUI.click(findTestObject('Object Repository/Page_MonikaSiregar/a_Repositories                      5'))
