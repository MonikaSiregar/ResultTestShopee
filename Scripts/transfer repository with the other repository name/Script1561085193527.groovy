...
WebUI.click(findTestObject('Object Repository/Page_Options/summary_Transfer'))

WebUI.setText(findTestObject('Object Repository/Page_Options/input_Type the name of the repository to confirm_confirm_repository_name'), 
    'testShopee')

WebUI.setText(findTestObject('Object Repository/Page_Options/input_New owners GitHub username or organization name_new_owner'), 
    'ronaldhutajulu')

WebUI.click(findTestObject('Object Repository/Page_Options/button_I understand transfer this repository'))
