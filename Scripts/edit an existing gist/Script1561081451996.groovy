...
WebUI.click(findTestObject('Object Repository/Page_GitHub/span_test-shopee'))

WebUI.click(findTestObject('Object Repository/Page_MonikaSiregartest-shopee/a_Settings'))

WebUI.setText(findTestObject('Object Repository/Page_Options/input_Repository name_new_name'), 'test-shopee-edit')

WebUI.click(findTestObject('Object Repository/Page_Options/button_Rename'))
